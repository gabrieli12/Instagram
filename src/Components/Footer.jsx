...
function Footer() {
  return (
    <footer className='w-full p-1 mt-1'>
        <div className='text-[#a8a8a8] text-[0.9em] flex items-center justify-center gap-5 mb-2'>
        ...
        <div className='text-[#a8a8a8] text-[0.9em] w-full flex justify-center items-center gap-5'>
            <select>
